...
MIN_AREA = 100 #delete small area
...
if __name__ == '__main__':
    ...
    for current_file in file_list:
        ...
        output_image = current_result1_image + current_result2_image # logical AND
        output_image = np.clip(output_image, 0, 1)

        output_image = delete_small_Area(output_image * 255, MIN_AREA)
        output_image = np.clip(output_image, 0, 1)
