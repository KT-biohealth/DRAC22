...
if platform.system() =='Linux': #check if in Server
    DATA_PATH = r"/userdata/common/MICCAI2022/DRAC/task2/input/"
    os.environ['TORCH_HOME'] = '/userdata/common/MICCAI2022/DRAC/timm_model'
else:
...
CSV_NAME_VAL = 'test.csv'
CSV_RESULT = '_train_result.csv'

STEP_SIZE = 3
OUTPUT_FOLDER = 'ouput_beit_enhance_pseudo_7802'
